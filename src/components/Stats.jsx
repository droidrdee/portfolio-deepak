  ...
  const stats = [
    {
      ...
      desc: 'on Cost Estimation Platform — eliminating memory leaks, restructuring N+1 queries, and migrating to async I/O.',
      accent: 'violet',
    },
    {
      icon: <FaUsers />,
      ...
      desc: 'from 3–4 to 25–30+ concurrent users per client through profiling, pooling, and async refactoring.',
      accent: 'cyan',
    },
    {
      icon: <FaClock />,
      ...
      desc: 'in peak API response time across the full backend stack — measurable and reproducible.',
      accent: 'pink',
    },
    {
      icon: <FaCheckCircle />,
      ...
      desc: 'handled across 5+ REST endpoints with normalised schemas and tuned query indexes.',
      accent: 'lime',
    },
  ];
