  ...
  const categories = [
    {
      ...
      icon: <HiSparkles />,
      accent: 'violet',
      summary: 'LangChain, agents, fine-tuning, prompt engineering',
      items: [
        { name: 'LangChain', icon: <SiLangchain />, level: 'Expert' },
        { name: 'LlamaIndex', icon: <TbBrain />, level: 'Expert' },
        { name: 'OpenAI API', icon: <SiOpenai />, level: 'Expert' },
        ...
        { name: 'LoRA / QLoRA Fine-Tuning', icon: <HiCpuChip />, level: 'Advanced' },
    ...
    },
    {
      ...
      accent: 'cyan',
      summary: 'Retrieval pipelines, semantic search, re-ranking',
      items: [
        ...
        { name: 'Weaviate', icon: <TbDatabase />, level: 'Intermediate' },
    ...
    },
    {
      ...
      icon: <HiCloud />,
      accent: 'cyan',
      summary: 'Vertex AI, Bedrock, CI/CD for AI workloads',
      items: [
        { name: 'Vertex AI (Gemini Pro)', icon: <SiGooglecloud />, level: 'Expert' },
        { name: 'AWS Bedrock', icon: <FaAws />, level: 'Advanced' },
        { name: 'LLMOps', icon: <HiCloud />, level: 'Expert' },
        { name: 'CI/CD for AI', icon: <SiGithubactions />, level: 'Advanced' },
        { name: 'Docker', icon: <FaDocker />, level: 'Expert' },
        { name: 'Streamlit Cloud', icon: <SiStreamlit />, level: 'Advanced' },
        { name: 'Heroku', icon: <SiHeroku />, level: 'Advanced' },
      ],
    },
    {
      key: 'backend',
